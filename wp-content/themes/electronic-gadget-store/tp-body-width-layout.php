...
// footer widget title font size
	$electronic_gadget_store_footer_widget_title_font_size = get_theme_mod('electronic_gadget_store_footer_widget_title_font_size', '');{
	$electronic_gadget_store_tp_theme_css .='#footer h3, #footer h2.wp-block-heading{';
		$electronic_gadget_store_tp_theme_css .='font-size: '.esc_attr($electronic_gadget_store_footer_widget_title_font_size).'px;';
	$electronic_gadget_store_tp_theme_css .='}';
	}

	// Copyright text font size
	$electronic_gadget_store_footer_copyright_font_size = get_theme_mod('electronic_gadget_store_footer_copyright_font_size', '');{
	$electronic_gadget_store_tp_theme_css .='#footer .site-info p{';
		$electronic_gadget_store_tp_theme_css .='font-size: '.esc_attr($electronic_gadget_store_footer_copyright_font_size).'px;';
	$electronic_gadget_store_tp_theme_css .='}';
	}

	// copyright padding
	$electronic_gadget_store_footer_copyright_top_bottom_padding = get_theme_mod('electronic_gadget_store_footer_copyright_top_bottom_padding', '');
	if ($electronic_gadget_store_footer_copyright_top_bottom_padding !== '') { 
	    $electronic_gadget_store_tp_theme_css .= '.site-info {';
	    $electronic_gadget_store_tp_theme_css .= 'padding-top: ' . esc_attr($electronic_gadget_store_footer_copyright_top_bottom_padding) . 'px;';
	    $electronic_gadget_store_tp_theme_css .= 'padding-bottom: ' . esc_attr($electronic_gadget_store_footer_copyright_top_bottom_padding) . 'px;';
	    $electronic_gadget_store_tp_theme_css .= '}';
	}