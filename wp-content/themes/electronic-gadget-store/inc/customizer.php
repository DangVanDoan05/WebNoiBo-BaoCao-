...
function Electronic_Gadget_Store_Customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('electronic_gadget_store_footer_copyright_font_size',array(
		'default'	=> '',
		'sanitize_callback'	=> 'electronic_gadget_store_sanitize_number_absint'
	));
	$wp_customize->add_control('electronic_gadget_store_footer_copyright_font_size',array(
		'label'	=> __('Change Footer Copyright Font Size in PX','electronic-gadget-store'),
		'section'	=> 'electronic_gadget_store_footer_section',
	    'setting'	=> 'electronic_gadget_store_footer_copyright_font_size',
		'type'	=> 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting( 'electronic_gadget_store_footer_copyright_text_color', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'electronic_gadget_store_footer_copyright_text_color', array(
			'label'     => __('Change Footer Copyright Text Color', 'electronic-gadget-store'),
	    'section' => 'electronic_gadget_store_footer_section',
	    'settings' => 'electronic_gadget_store_footer_copyright_text_color',
  	)));

  	$wp_customize->add_setting('electronic_gadget_store_footer_copyright_top_bottom_padding',array(
		'default'	=> '',
		'sanitize_callback'	=> 'electronic_gadget_store_sanitize_number_absint'
	));
	$wp_customize->add_control('electronic_gadget_store_footer_copyright_top_bottom_padding',array(
		'label'	=> __('Change Footer Copyright Padding in PX','electronic-gadget-store'),
		'section'	=> 'electronic_gadget_store_footer_section',
	    'setting'	=> 'electronic_gadget_store_footer_copyright_top_bottom_padding',
		'type'	=> 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
	...
	//footer widget title font size
	$wp_customize->add_setting('electronic_gadget_store_footer_widget_title_font_size',array(
		'default'	=> '',
		'sanitize_callback'	=> 'electronic_gadget_store_sanitize_number_absint'
	));
	$wp_customize->add_control('electronic_gadget_store_footer_widget_title_font_size',array(
		'label'	=> __('Change Footer Widget Title Font Size in PX','electronic-gadget-store'),
		'section'	=> 'electronic_gadget_store_footer_section',
	    'setting'	=> 'electronic_gadget_store_footer_widget_title_font_size',
		'type'	=> 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting( 'electronic_gadget_store_footer_widget_title_color', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'electronic_gadget_store_footer_widget_title_color', array(
			'label'     => __('Change Footer Widget Title Color', 'electronic-gadget-store'),
	    'section' => 'electronic_gadget_store_footer_section',
	    'settings' => 'electronic_gadget_store_footer_widget_title_color',
  	)));
...
if ( ! defined( 'ELECTRONIC_GADGET_DEMO_TITLE' ) ) {
	define( 'ELECTRONIC_GADGET_DEMO_TITLE', esc_html__( 'Click to View Site', 'electronic-gadget-store' ));
}
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new electronic_gadget_store_Customize_Section_Pro(
				...
				array(
					'priority'   => 9,
					'title'    => ELECTRONIC_GADGET_DEMO_TITLE,
