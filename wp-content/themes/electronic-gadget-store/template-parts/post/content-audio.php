...
<?php
  ...
  if ( false === strpos( $electronic_gadget_store_content, 'wp-playlist-script' ) ) {
    $audio = get_media_embedded_in_content( $electronic_gadget_store_content, array( 'audio' ) );
  }
?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      <div class="page-box">
        ...
        <div class="box-content mt-2 text-center">
          ...
          <div class="box-info">
            <?php 
            $electronic_gadget_store_blog_archive_ordering = get_theme_mod('blog_meta_order', array('date', 'author', 'comment', 'category'));
            foreach ($electronic_gadget_store_blog_archive_ordering as $electronic_gadget_store_blog_data_order) : 
                ...
                <?php elseif ('comment' === $electronic_gadget_store_blog_data_order) : ?>
                    ...
                    <a href="<?php comments_link(); ?>" class="entry-comments">
                        <?php comments_number(__('0 Comments', 'electronic-gadget-store'), __('1 Comment', 'electronic-gadget-store'), __('% Comments', 'electronic-gadget-store')); ?>
                    </a>
